...
public final class PackageUploadAction_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//checking if request cotains multipart data
    ...
    if (isMultipart) {
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            } else//when it is an image or multipart
            {
                ...
                if (field_name.equals("file_photo"))//write the name of image here it is img_product
                {
                    ...
                    String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\Package\\";//path for storing image
            ...
            String InsQry = "INSERT INTO `tbl_package`( `package_name`, `package_details`, `package_photo`,`package_amount`,package_days,place_id)"
                    + "values('" + value[0] + "','" + value[1] + "','" + photo + "','" + value[2] + "','" + value[3] + "','" + value[4]+"')";
      ...
      out.write("        window.location.href = '../../Admin/Package.jsp'\n");
